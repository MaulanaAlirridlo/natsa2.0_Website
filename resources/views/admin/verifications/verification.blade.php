<x-app-layout title="Verifications">
    <div class="container grid px-6 mx-auto">
        ...
        <div class="w-full overflow-hidden rounded-lg shadow-xs">
            ...
            <form action="{{ route('admin.verifications.search') }}" method="GET" id="verificationFilter">
                            ...
                            <label class="block text-sm mt-4">
                                ...
                                <select name="sort" id="sort"
                                    ...
                                    <option @isset($_GET['sort']) @if ($_GET['sort']=='id' ) selected @endif @endisset
                                        value="id">ID</option>
                                    <option @isset($_GET['sort']) @if ($_GET['sort']=='verification_type' ) selected
                                        @endif @endisset value="verification_type">Title</option>
                                    <option @isset($_GET['sort']) @if ($_GET['sort']=='desc' ) selected @endif @endisset
