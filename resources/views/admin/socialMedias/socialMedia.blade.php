<x-app-layout title="Social Media">
    <div class="container grid px-6 mx-auto">
        ...
        <div class="w-full overflow-hidden rounded-lg shadow-xs">
            ...
            <form action="{{ route('admin.socialMedias.search') }}" method="GET" id="regionFilter">
                            ...
                            <label class="block text-sm mt-4">
                                ...
                                <select name="sort" id="sort"
                                    ...
                                    <option @isset($_GET['sort']) @if ($_GET['sort']=='id' ) selected @endif @endisset
                                        value="id">ID</option>
                                    <option @isset($_GET['sort']) @if ($_GET['sort']=='sosmed' ) selected @endif
                                        @endisset value="sosmed">Title</option>
                                ...
                                <div class="flex items-center text-sm">
                                    <div class="relative hidden w-8 h-8 mr-3 rounded-full md:block">
                                        <img class="object-cover w-full h-full rounded-full"
                                            src="{{ '/storage/'.$socialMedia->icon_path }}" alt="" loading="lazy" />
