<x-app-layout title="Irrigations">
    <div class="container grid px-6 mx-auto">
        ...
        <div class="w-full overflow-hidden rounded-lg shadow-xs">
            ...
            <form action="{{ route('admin.irrigations.update', $irrigation) }}" method="POST" id="irrigationPut">
                @csrf
                @method('PUT')
                <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
                    <label class="block text-sm">
                        ...
                        <input
                            ...
                            placeholder="Jenis Irigasi" name="irrigation" required maxlength="100" value="{{ $irrigation->irrigation }}" />
                    </label>
                    @error('irrigation')
        ...
        <div class="">
            ...
            <button type="submit" form="irrigationPut"
